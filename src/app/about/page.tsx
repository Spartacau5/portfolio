    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="container home">
        ...
        <div className="w-layout-grid about-grid">
          ...
          <div className="bg-gradient-to-br from-blue-100 to-cyan-100 rounded-3xl overflow-hidden shadow-sm border border-gray-100 aspect-square flex flex-col">
          <div className="w-full h-full bg-gradient-to-br from-blue-300 to-teal-200 flex items-center justify-center">
