    ...
    return (
        <div className="case-study-page">
            ...
            <section ref={competitiveAnim.ref} className="case-study-content" style={fadeInUp(competitiveAnim.isVisible)}>
                <h2 className="content-heading">Competitive Analysis â€“ Tracker</h2>
            ...
            <section ref={userFlowsAnim.ref} className="case-study-content" style={fadeInUp(userFlowsAnim.isVisible)}>
                ...
                <div style={{ marginTop: '2rem' }}>
                    ...
                    <p className="content-text">
                        To validate the flow, I organized a focus group with our internal recruitment teamâ€”our ideal user persona. This involved significant effort: sending invites, scheduling sessions, preparing scripts, recording feedback, and collaborating with another designer for note-taking.
                    </p>
                    <p className="content-text">
