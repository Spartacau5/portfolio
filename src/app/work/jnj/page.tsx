                ...
                <div className="case-study-description">
                    ...
                    <div className="description-block">
                        ...
                        <p className="description-text">
                            This project was in collaboration with an incredible design agency <a href="https://www.jkcommsagency.com/" target="_blank" rel="noopener noreferrer" className="content-link">JK Design<svg className="content-link-arrow" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.5 2.5H9.5V8.5M9.5 2.5L2.5 9.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg></a>, for their long-term client: Johnson & Johnson. The goal was to design Johnson & Johnson's <a href="https://healthforhumanityreport.jnj.com/2024/" target="_blank" rel="noopener noreferrer" className="content-link">Health for Humanity Report<svg className="content-link-arrow" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.5 2.5H9.5V8.5M9.5 2.5L2.5 9.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg></a> and <a href="https://www.jnj.com/inclusion" target="_blank" rel="noopener noreferrer" className="content-link">Diversity, Equity, and Inclusion Report<svg className="content-link-arrow" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.5 2.5H9.5V8.5M9.5 2.5L2.5 9.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg></a> for the year 2021 in order to highlight their commitment to global health and inclusion.
                        </p>
                        <p className="description-text">
