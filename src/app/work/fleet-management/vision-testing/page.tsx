...
export default function VisionTestingPage() {
    ...
    useEffect(() => {
        if (sessionStorage.getItem('arrive-auth') !== 'true') {
            router.replace('/work/fleet-management');
        }
    }, [router]);
        ...
        <div className="case-study-page">
            ...
            <section className="case-study-hero">
                ...
                <p className="case-study-company">
                    ...
                    on a unified two-year vision for Arrive for Businessâ€”transforming fragmented
                ...
                <div className="case-study-description">
                    <div className="description-block">
                        ...
                        <p className="description-text">
                            ...
                            needed to consolidate insights into a unified two-year product visionâ€”but the organization
            ...
            <section ref={challengeAnim.ref} className="case-study-content" style={fadeInUp(challengeAnim.isVisible)}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '24px', marginTop: '48px' }}>
                    ...
                    <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '16px', padding: '32px', transition: 'all 0.2s' }}>
                        ...
                        <p style={{ fontSize: '14px', color: '#6b7280', lineHeight: 1.6 }}>
                            Executives needed clarity on investment prioritiesâ€”what to build first,
            ...
            <section ref={visionFrameworkAnim.ref} className="case-study-content" style={fadeInUp(visionFrameworkAnim.isVisible)}>
                ...
                <p style={{ fontSize: '18px', color: '#6b7280', marginBottom: '48px', maxWidth: '700px' }}>
                    ...
                    that form a narrative storyboardâ€”from first discovery to ongoing optimization.
                </p>
                    ...
                    <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '16px', padding: '28px', position: 'relative', transition: 'all 0.2s' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                            <span style={{ fontSize: '13px', color: '#9ca3af', paddingLeft: '16px', position: 'relative' }}>
                                <span style={{ position: 'absolute', left: 0, color: '#1f2937' }}>â†’</span>
            ...
            <section ref={workshop1Anim.ref} className="case-study-content" style={fadeInUp(workshop1Anim.isVisible)}>
                ...
                <p style={{ fontSize: '18px', color: '#6b7280', marginBottom: '48px', maxWidth: '700px' }}>
                    A two-day workshop sequence with 7 product managersâ€”starting with brutal honesty
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '32px', flexWrap: 'wrap', gap: '16px' }}>
                        <div>
                            ...
                            <p style={{ fontSize: '14px', color: '#9ca3af' }}>Stockholm, In-Person Â· Max-led, I designed</p>
                        </div>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '32px', flexWrap: 'wrap', gap: '16px' }}>
                        <div>
                            ...
                            <p style={{ fontSize: '14px', color: '#9ca3af' }}>Virtual, 60 minutes Â· I facilitated</p>
                        </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '32px', marginTop: '32px', padding: '32px', background: 'white', borderRadius: '16px', flexWrap: 'wrap', justifyContent: 'center', border: '1px solid #e5e7eb' }}>
                        ...
                        <span style={{ fontSize: '32px', color: '#1f2937' }}>â†’</span>
                        <div style={{ textAlign: 'center' }}>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '32px', flexWrap: 'wrap', gap: '16px' }}>
                        <div>
                            ...
                            <p style={{ fontSize: '14px', color: '#9ca3af' }}>Virtual Â· I facilitated</p>
                        </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '24px' }}>
                        ...
                        <div style={{ background: 'white', borderRadius: '12px', padding: '24px', border: '1px solid #e5e7eb' }}>
                            ...
                            <p style={{ fontSize: '14px', color: '#6b7280', lineHeight: 1.6 }}>
                                Browse Â· Onboard Â· Dashboard Â· Mobility Cards Â· Telematics Â·
                                Tolling Automation Â· Expense Management Â· Analyze
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section ref={workshop2Anim.ref} className="case-study-content" style={fadeInUp(workshop2Anim.isVisible)}>
                ...
                <p style={{ fontSize: '18px', color: '#6b7280', marginBottom: '48px', maxWidth: '700px' }}>
                    A cross-regional workshop with sales representatives from US and EU marketsâ€”defining
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '32px', flexWrap: 'wrap', gap: '16px' }}>
                        <div>
                            ...
                            <p style={{ fontSize: '14px', color: '#9ca3af' }}>Virtual Â· December 11 Â· I facilitated</p>
                        </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '24px' }}>
                        <div style={{ background: 'white', borderRadius: '12px', padding: '24px', border: '1px solid #e5e7eb' }}>
                            ...
                            <p style={{ fontSize: '14px', color: '#6b7280', lineHeight: 1.6 }}>
                                Marcus Â· Markus Â· Simon Â· Nathaniel Â· Nikita and leadership
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', marginBottom: '32px' }}>
                    <div style={{ background: '#1f2937', borderRadius: '16px', padding: '28px', color: 'white' }}>
                        ...
                        <p style={{ fontSize: '14px', opacity: 0.85, lineHeight: 1.6 }}>Onboarding open for the enterprise and opt-in for employees to sign upâ€”adaptable to different configurations.</p>
                        <p style={{ marginTop: '16px', fontSize: '13px', opacity: 0.6 }}>â€” Emily Stuart</p>
                    </div>
                    <div style={{ background: '#1f2937', borderRadius: '16px', padding: '28px', color: 'white' }}>
                        <h4 style={{ fontSize: '16px', fontWeight: 600, marginBottom: '12px' }}>Meet customers where they are</h4>
                        <p style={{ fontSize: '14px', opacity: 0.85, lineHeight: 1.6 }}>Integrations across their ecosystemâ€”seamlessly connect with the tools, platforms, and workflows customers already use.</p>
                        <p style={{ marginTop: '16px', fontSize: '13px', opacity: 0.6 }}>â€” Emily Stuart</p>
                    </div>
                    <div style={{ background: '#1f2937', borderRadius: '16px', padding: '28px', color: 'white' }}>
            ...
            <section ref={workshop3Anim.ref} className="case-study-content" style={fadeInUp(workshop3Anim.isVisible)}>
                ...
                <p style={{ fontSize: '18px', color: '#6b7280', marginBottom: '48px', maxWidth: '700px' }}>
                    ...
                    by the sales teamâ€”surfacing regional nuances and strategic considerations.
                </p>
            ...
            <section ref={synthesisAnim.ref} className="case-study-content" style={fadeInUp(synthesisAnim.isVisible)}>
                ...
                <p style={{ fontSize: '18px', color: '#6b7280', marginBottom: '48px', maxWidth: '700px' }}>
                    Across all three workshops, six consistent themes emergedâ€”providing a clear
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' }}>
                    {[
                        ...
                        { num: '02', title: 'Value beyond parking in broader mobility capabilities', desc: 'Mobility cards, telematics, and tolling automation were viewed as important capabilities that extend the offering beyond parkingâ€”supporting a shift toward a broader mobility platform.' },
                        ...
                        { num: '06', title: 'Priorities and needs vary by market', desc: 'Some capabilities like EV charging and parking restrictions were prioritized differently across marketsâ€”highlighting the need for a thoughtful, market-aware approach.' },
                    ].map((item, i) => (
                    ...
                    <div style={{ marginBottom: '48px' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '16px' }}>
                            <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderLeft: '3px solid #1f2937', borderRadius: '0 12px 12px 0', padding: '20px' }}>
                                ...
                                <p style={{ fontSize: '13px', color: '#6b7280' }}>Highlight SSO capabilitiesâ€”add into the story to get feedback from customers on enterprise authentication needs.</p>
                            </div>
            ...
            <section ref={impactAnim.ref} className="case-study-content" style={fadeInUp(impactAnim.isVisible)}>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '32px', marginBottom: '48px' }}>
                        ...
                        <div style={{ textAlign: 'center' }}>
                            <div style={{ fontSize: '48px', fontWeight: 700, color: '#1f2937', marginBottom: '8px' }}>Câ†’A</div>
                    ...
                    <div style={{ background: 'white', borderRadius: '16px', padding: '32px', position: 'relative', border: '1px solid #e5e7eb' }}>
                        ...
                        <span style={{ paddingLeft: '48px', color: '#9ca3af', fontSize: '14px' }}>â€” Workshop Synthesis</span>
                    </div>
                </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '24px', marginTop: '48px' }}>
                    {[
                        { num: 'Outcome 1', title: 'Unified Vision Document', desc: "A clear, actionable two-year product vision aligned across Product, Sales, and Leadershipâ€”ready for customer validation." },
                        { num: 'Outcome 2', title: 'Prioritized Feature Roadmap', desc: 'Consensus on what must be included, should be included, and can be deprioritizedâ€”with regional nuances documented.' },
            ...
            <section ref={reflectionAnim.ref} className="case-study-content" style={fadeInUp(reflectionAnim.isVisible)}>
                ...
                <p style={{ fontSize: '24px', fontWeight: 400, lineHeight: 1.5, fontStyle: 'italic', fontSynthesis: 'none', marginBottom: '48px', color: '#1f2937' }}>
                    "This project demonstrated how structured facilitation can transform fragmented perspectives into shared strategic directionâ€”a capability as valuable as traditional research."
                </p>
                ...
                <p className="content-text">
                    The grade transformationâ€”from C/D/F to A/B across seven product managersâ€”was not just about the vision itself improving. It was about the shift from passive criticism to active ownership. Once PMs contributed their own sketches and saw their ideas reflected in the prototype, they became advocates rather than skeptics.
                </p>
                <p className="content-text">
                    This project reinforced for me that facilitation is a research skill. Understanding group dynamics, designing for productive conflict, and creating artifacts that people want to referenceâ€”these are as important as interview technique or synthesis methodology.
                </p>
            </section>
            ...
            <div className="case-study-bottom-nav">
                <Link href="/work/fleet-management" className="back-link">
                    <Image src="/images/arrow-angle.svg" alt="" width={16} height={16} className="back-arrow" />
                    Back to Arrive
                </Link>
                <Link href="/work/fleet-management/parking-planner" className="back-link">
