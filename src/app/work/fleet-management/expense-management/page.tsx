        ...
        <div className="case-study-page">
            ...
            <section className="case-study-meta-section">
                ...
                <div className="case-study-description">
                    ...
                    <div className="description-block">
                        ...
                        <p className="description-text">
                            However, EasyPark&apos;s model was almost &quot;too simple.&quot; They billed enterprises in aggregate, meaning drivers didn&apos;t need to submit individual expenses. While this reduced friction for drivers, it conflicted with how large enterprises operateâ€”requiring transaction-level visibility for auditing, compliance, approvals, cost allocation, and policy enforcement.
                        </p>
                        <p className="description-text">
            ...
            <section ref={approachAnim.ref} className="case-study-content" style={fadeInUp(approachAnim.isVisible)}>
                ...
                <div className="synthesis-flow" style={{ display: 'flex', alignItems: 'stretch', justifyContent: 'space-between', margin: '48px 0', flexWrap: 'wrap', gap: '12px' }}>
                    ...
                    <span className="flow-arrow" style={{ color: '#9ca3af', fontSize: '20px', padding: '0 12px', display: 'flex', alignItems: 'center' }}>â†’</span>
            ...
            <section ref={frameworkAnim.ref} className="case-study-content" style={fadeInUp(frameworkAnim.isVisible)}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '32px', margin: '48px 0' }}>
                    <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '16px', padding: '40px 32px', textAlign: 'center', position: 'relative' }}>
                        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '4px', background: '#1f2937', borderRadius: '16px 16px 0 0' }}></div>
                        <div style={{ width: '64px', height: '64px', background: 'rgba(31, 41, 55, 0.08)', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 24px', fontSize: '28px' }}>âš¡</div>
                    ...
                    <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '16px', padding: '40px 32px', textAlign: 'center', position: 'relative' }}>
                        ...
                        <div style={{ width: '64px', height: '64px', background: 'rgba(107, 114, 128, 0.08)', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 24px', fontSize: '28px' }}>ðŸ›¡ï¸</div>
                    ...
                    <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '16px', padding: '40px 32px', textAlign: 'center', position: 'relative' }}>
                        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '4px', background: '#9ca3af', borderRadius: '16px 16px 0 0' }}></div>
                        <div style={{ width: '64px', height: '64px', background: 'rgba(156, 163, 175, 0.08)', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 24px', fontSize: '28px' }}>ðŸ”—</div>
                        <h3 style={{ fontSize: '24px', fontWeight: 700, marginBottom: '16px', color: '#9ca3af' }}>Alignment</h3>
                        <p style={{ fontSize: '15px', color: '#4b5563', lineHeight: 1.6, margin: 0 }}>Fit smoothly into existing processes and systemsâ€”Concur, HRIS, ERPâ€”without creating new workflows.</p>
                    </div>
                </div>
            </section>
            ...
            <section ref={insight1Anim.ref} className="case-study-content insight-section" style={{ borderBottom: '1px solid #e5e7eb', paddingTop: '40px', ...fadeInUp(insight1Anim.isVisible) }}>
                ...
                <h3 style={{ fontSize: '28px', fontWeight: 700, marginBottom: '24px', maxWidth: '800px' }}>Integrations will not be for everyoneâ€”retaining monthly invoicing is important</h3>
            ...
            <section ref={insight5Anim.ref} className="case-study-content insight-section" style={{ paddingTop: '40px', ...fadeInUp(insight5Anim.isVisible) }}>
                ...
                <h3 style={{ fontSize: '28px', fontWeight: 700, marginBottom: '24px', maxWidth: '800px' }}>Drivers wanted simple and frictionlessâ€”but doubted company buy-in</h3>
                <p className="content-text" style={{ maxWidth: '800px', marginBottom: '32px' }}>
            ...
            <section ref={impactAnim.ref} className="case-study-content" style={fadeInUp(impactAnim.isVisible)}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '24px', margin: '48px 0' }}>
                    ...
                    <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '16px', padding: '28px', textAlign: 'center' }}>
                        <div style={{ fontSize: '48px', fontWeight: 800, color: '#1f2937', lineHeight: 1, marginBottom: '8px' }}>â†’</div>
                ...
                <div style={{ background: 'linear-gradient(135deg, rgba(31, 41, 55, 0.05), rgba(107, 114, 128, 0.05))', border: '1px solid rgba(31, 41, 55, 0.15)', borderRadius: '16px', padding: '40px', margin: '48px 0' }}>
                    ...
                    <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>â€” Senior Stakeholder, Onsite Sprint</p>
                </div>

                <p className="content-text">
                    The final debrief was presented to senior B2B leadership across EU and US markets. It was received extremely well and was instrumental in securing additional research workâ€”directly leading to the B2B Vision Testing initiative.
                </p>

                {/* Connection Banner */}
                <Link href="/work/fleet-management/vision-testing" style={{ textDecoration: 'none' }}>
                    <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '16px', padding: '32px 40px', display: 'flex', alignItems: 'center', gap: '24px', margin: '48px 0', cursor: 'pointer', transition: 'all 0.2s' }}>
                        <div style={{ width: '64px', height: '64px', background: 'rgba(31, 41, 55, 0.08)', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '28px', flexShrink: 0 }}>ðŸ”—</div>
                        <div style={{ flex: 1 }}>
                            ...
                            <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>The success of this work earned trust that led to the broader B2B Vision initiativeâ€”reimagining the entire self-service experience by gathering compelling priorities from customers, sales, and product leaders.</p>
                        </div>
                        <span style={{ color: '#1f2937', fontSize: '24px' }}>â†’</span>
                    </div>
                </Link>
            </section>
            ...
            <section ref={reflectionAnim.ref} className="case-study-content" style={fadeInUp(reflectionAnim.isVisible)}>
                ...
                <p className="content-text">
                    The work required constant coordinationâ€”between Arrive&apos;s product and leadership teams in EU and US, and Craft&apos;s product and leadership teamsâ€”keeping both parties satisfied with quality and pace. I managed the full research arc from discussion guide design through progressive stakeholder updates to final executive debrief.
                </p>
                <p className="content-text">
                    Most importantly, this research wasn&apos;t just about validating features. It was about understanding how EasyPark needed to position itself within enterprise financial ecosystemsâ€”and that strategic clarity is what made the findings valuable enough to earn expanded scope into the B2B Vision Testing initiative.
                </p>
            </section>
            ...
            <div className="case-study-bottom-nav">
                ...
                <Link href="/work/fleet-management/vision-testing" className="back-link">
