        ...
        <div className="case-study-page">
                ...
                <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '16px', padding: '40px 32px' }}>
                    ...
                    <div className="research-timeline" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0', position: 'relative' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', position: 'relative', zIndex: 1 }}>
                            ...
                            <span style={{ fontSize: '13px', color: '#6b7280', marginBottom: '12px' }}>Week 1â€“2</span>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', position: 'relative', zIndex: 1 }}>
                            ...
                            <span style={{ fontSize: '13px', color: '#6b7280', marginBottom: '12px' }}>Week 2â€“4</span>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', position: 'relative', zIndex: 1 }}>
                            ...
                            <span style={{ fontSize: '13px', color: '#6b7280', marginBottom: '12px' }}>Week 4â€“5</span>
            ...
            <section ref={recruitmentAnim.ref} className="case-study-content" style={fadeInUp(recruitmentAnim.isVisible)}>
                ...
                <div className="channel-eval-mobile" style={{ display: 'flex', flexDirection: 'column', gap: '12px', margin: '24px 0' }}>
                    <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '12px', padding: '16px 20px' }}>
                        ...
                        <div style={{ fontSize: '13px', color: '#6b7280', lineHeight: 1.6 }}>
                            ...
                            <span style={{ color: '#ef4444' }}>âˆ’</span> Limited pool, compliance risk
                        </div>
                    </div>
                    <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '12px', padding: '16px 20px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                        ...
                        <div style={{ fontSize: '13px', color: '#6b7280', lineHeight: 1.6 }}>
                            ...
                            <span style={{ color: '#ef4444' }}>âˆ’</span> Slow, dependent on third party
                        </div>
                    </div>
                    <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '12px', padding: '16px 20px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                        ...
                        <div style={{ fontSize: '13px', color: '#6b7280', lineHeight: 1.6 }}>
                            ...
                            <span style={{ color: '#ef4444' }}>âˆ’</span> 3-week lead time, limited persona
                        </div>
                    </div>
                    <div style={{ background: 'rgba(34, 197, 94, 0.08)', border: '2px solid #22c55e', borderRadius: '12px', padding: '16px 20px' }}>
                        ...
                        <div style={{ fontSize: '13px', color: '#6b7280', lineHeight: 1.6 }}>
                            ...
                            <span style={{ color: '#ef4444' }}>âˆ’</span> Manual screening needed
                        </div>
                    </div>
                </div>
                ...
                <div style={{ padding: '12px 0', margin: '8px 0' }}>
                    <p style={{ fontSize: '16px', color: '#9ca3af', lineHeight: 1.7, fontStyle: 'italic' }}>
                        Note â€” Previous Craft researchers had found success recruiting blue-collar drivers via Craigslist. Given the 5-week timeline, this was the right tradeoff between speed, cost, and targeting precision.
                    </p>
                </div>
            ...
            <section className="case-study-content">
                ...
                <div className="synthesis-flow" style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr auto 1fr auto 1fr', alignItems: 'center', margin: '24px 0 48px', gap: '12px' }}>
                    ...
                    <span className="flow-arrow flow-arrow-1" style={{ color: '#9ca3af', fontSize: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>â†’</span>
                    ...
                    <span className="flow-arrow flow-arrow-2" style={{ color: '#9ca3af', fontSize: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>â†“</span>
                    ...
                    <span className="flow-arrow flow-arrow-3" style={{ color: '#9ca3af', fontSize: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>â†’</span>
                        ...
                        <div style={{ background: '#f9fafb', borderRadius: '12px', padding: '20px', border: '1px solid #e5e7eb' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '14px' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                    <span style={{ fontSize: '13px', fontWeight: 600, color: '#111827', minWidth: '80px' }}>Small (1â€“50)</span>
                    ...
                    <div>
                        ...
                        <div style={{ background: '#f9fafb', borderRadius: '12px', padding: '20px', border: '1px solid #e5e7eb' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '14px' }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                    <span style={{ fontSize: '13px', fontWeight: 600, color: '#111827', minWidth: '80px' }}>Med (50â€“500)</span>
            ...
            <div className="case-study-bottom-nav">
                ...
                <Link href="/work/fleet-management/expense-management" className="back-link">
