...
/**
 * Looping Fleet Management brand sequence for the work card.
 *
 *   1. The EasyPark logo animates in (scales up + fades) and settles.
 *   2. Brief hold, then a slick crossfade into the parking-planner video.
...
export function FleetLogoLoop({ className = '' }: { className?: string }) {
        ...
        <div className={`absolute inset-0 ${className}`}>
            <AnimatePresence mode="sync" initial={false}>
                {showVideo ? (
                    ...
                    >
                        <BrandLoopVideo
                            src="/images/parking-planner.mp4"
